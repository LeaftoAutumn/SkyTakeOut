...
-- ----------------------------
INSERT INTO `address_book` VALUES (3, 4, '自行车', '0', '18349650223', '33', '浙江省', '3305', '湖州市', '330502', '吴兴区', '啊打发打发', '2', 1);
...
INSERT INTO `category` VALUES (18, 1, '特色蒸菜', 6, 1, '2022-06-09 22:17:42', '2025-04-17 17:53:12', 1, 1);
...
INSERT INTO `dish` VALUES (47, '北冰洋', 11, 3.00, 'https://sky-itcast.oss-cn-beijing.aliyuncs.com/4451d4be-89a2-4939-9c69-3a87151cb979.png', '还是小时候的味道', 1, '2022-06-10 09:18:49', '2025-04-17 11:29:09', 1, 1);
...
INSERT INTO `dish` VALUES (60, '梅菜扣肉', 18, 58.00, 'https://sky-itcast.oss-cn-beijing.aliyuncs.com/6080b118-e30a-4577-aab4-45042e3f88be.png', '原料：猪肉，梅菜', 1, '2022-06-10 10:26:03', '2025-04-17 18:46:25', 1, 1);
INSERT INTO `dish` VALUES (61, '剁椒鱼头', 18, 88.00, 'https://leaf-ordering-platform.oss-cn-beijing.aliyuncs.com/dishImage/7d767150-7356-4343-bc87-ce0d9d2efed0.png', '原料：鲢鱼，剁椒', 1, '2022-06-10 10:28:54', '2025-04-17 11:28:51', 1, 1);
...
INSERT INTO `dish` VALUES (66, '江团鱼2斤', 16, 119.00, 'https://sky-itcast.oss-cn-beijing.aliyuncs.com/a101a1e9-8f8b-47b2-afa4-1abd47ea0a87.png', '配料：江团鱼，黄豆芽，莲藕', 1, '2022-06-10 10:42:42', '2025-04-17 12:18:09', 1, 1);
...
INSERT INTO `dish` VALUES (69, '平菇豆腐汤', 21, 6.00, 'https://sky-itcast.oss-cn-beijing.aliyuncs.com/16d0a3d6-2253-4cfc-9b49-bf7bd9eb2ad2.png', '配料：豆腐，平菇', 0, '2022-06-10 10:55:02', '2025-04-17 12:17:37', 1, 1);
INSERT INTO `dish` VALUES (71, '白面馒头', 12, 2.00, 'https://leaf-ordering-platform.oss-cn-beijing.aliyuncs.com/dishImage/179a875a-c0da-480e-a128-7e56ef85c438.png', '平平无奇的食物', 1, '2025-04-15 17:14:58', '2025-04-16 22:25:34', 1, 1);
...
CREATE TABLE `dish_flavor`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 113 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '菜品口味关系表' ROW_FORMAT = Dynamic;
...
INSERT INTO `dish_flavor` VALUES (104, 71, '甜味', '[\"无糖\",\"少糖\",\"半糖\",\"多糖\",\"全糖\"]');
INSERT INTO `dish_flavor` VALUES (110, 61, '辣度', '[\"不辣\",\"微辣\",\"中辣\",\"重辣\"]');
INSERT INTO `dish_flavor` VALUES (111, 61, '忌口', '[\"不要葱\",\"不要蒜\",\"不要香菜\",\"不要辣\"]');
INSERT INTO `dish_flavor` VALUES (112, 61, '甜味', '[\"无糖\",\"少糖\",\"半糖\",\"多糖\",\"全糖\"]');
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '员工信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of employee
-- ----------------------------
INSERT INTO `employee` VALUES (1, '管理员', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '13812312312', '1', '110101199001010047', 1, '2022-02-15 15:51:20', '2025-04-15 20:48:34', 10, 1);
INSERT INTO `employee` VALUES (4, 'leaf', 'Leaf', 'e10adc3949ba59abbe56e057f20f883e', '3333333', 'w', '999999', 1, '2025-04-10 22:53:48', '2025-04-13 15:19:27', 1, 1);
INSERT INTO `employee` VALUES (5, '张三', 'zhangsan', 'e10adc3949ba59abbe56e057f20f883e', '18399998888', '1', '111111222233334444', 1, '2025-04-11 16:25:21', '2025-04-14 21:19:44', 1, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '套餐' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of setmeal
-- ----------------------------
INSERT INTO `setmeal` VALUES (32, 13, '优惠午餐', 14.00, 1, '快来选购！！！', 'https://leaf-ordering-platform.oss-cn-beijing.aliyuncs.com/dishImage/cf723007-2363-4eae-893d-fb47b317ce75.png', '2025-04-16 12:25:18', '2025-04-17 18:46:28', 1, 1);
INSERT INTO `setmeal` VALUES (35, 15, '鱼头菜', 27.00, 1, '不错的选择。', 'https://leaf-ordering-platform.oss-cn-beijing.aliyuncs.com/dishImage/58163340-1795-4e6d-a1f1-f63bfac505fe.png', '2025-04-17 18:59:27', '2025-04-17 18:59:37', 1, 1);
...
CREATE TABLE `setmeal_dish`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 62 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '套餐菜品关系' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of setmeal_dish
-- ----------------------------
INSERT INTO `setmeal_dish` VALUES (53, 32, 49, '米饭', 2.00, 1);
INSERT INTO `setmeal_dish` VALUES (54, 32, 54, '清炒小油菜', 18.00, 1);
INSERT INTO `setmeal_dish` VALUES (55, 32, 68, '鸡蛋汤', 4.00, 1);
INSERT INTO `setmeal_dish` VALUES (56, 32, 60, '梅菜扣肉', 58.00, 1);
INSERT INTO `setmeal_dish` VALUES (59, 35, 57, '炝炒圆白菜', 18.00, 1);
INSERT INTO `setmeal_dish` VALUES (60, 35, 51, '老坛酸菜鱼', 56.00, 1);
INSERT INTO `setmeal_dish` VALUES (61, 35, 71, '白面馒头', 2.00, 1);
...
CREATE TABLE `shopping_cart`  (
  ...
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '购物车' ROW_FORMAT = Dynamic;
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (4, 'ooIYI7JVdimKcANokslzbCc3ee7U', NULL, NULL, NULL, NULL, NULL, '2025-04-16 21:46:54');
